...
# --- Force unload kernel drivers first ---
log "Forcing unload of kernel RTL-SDR modules..."
modprobe -r rtl2832_sdr rtl2832 dvb_usb_rtl28xxu dvb_usb_v2 2>/dev/null || true
sleep 2
